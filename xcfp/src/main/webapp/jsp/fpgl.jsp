...
<div class="demoTable">
    ...
    <button class="layui-btn" data-type="reload">查看返贫用户</button>
</div>
...
<script>
    ...
    layui.use('table', function() {
        ...
        table.render({
            elem : '#demo',  //绑定table表格
            height : 500,
            url : '${pageContext.request.contextPath}/findFanPin.action' //数据接口
        ...
        var $ = layui.$, active = {
            reload: function(){
                ...
                table.reload('testReload', {
                    page:true,
                    url:'${pageContext.request.contextPath}/findFanPinByCity.action',
                    method:'post',
