  ...
  <script>
      $(function(){
          $("button").click(function(){
              ...
              $.ajax({
                  url:'${pageContext.request.contextPath}/updatePku.action',
                  method:'POST',
                  data:{"id":id,"name":name,"province":province,
...
<div class="layui-input-block">
  <input type="text" name="rjcsh" value="${requestScope.mu.rjcsh}" placeholder="请输入人均年收入" autocomplete="off" class="layui-input">
</div>
</div>
<div class="layui-form-item">
